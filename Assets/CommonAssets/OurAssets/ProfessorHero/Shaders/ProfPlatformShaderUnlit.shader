...
Shader "HoloWorld/Prof Platform Shader Unlit"
{
    Properties
    {
		_SpeedOfGlowing("Speed of Glowing", Float) = 3
		_TargetAreaTreshold("Target Area Treshold", Range(0, 1)) = 0.9
		_GlowingForce("Value of Glowing", Range(0, 1)) = 0.3
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "ProfPlatformShaderUnlit.cginc"
