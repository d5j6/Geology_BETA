...
Shader "HoloWorld/Cursor Shader"
{
	Properties
	{
		_TimePulsingInterval("Interval of Pulsing", Float) = 0.5
		_SectorWidth("Width of Sector", Range(0, 1)) = 0.35
		_MinAlpha("Minimum Alpha", Range(0, 1)) = 0.3
		_MaxAlpha("Maximum Alpha", Range(0, 1)) = 0.6
