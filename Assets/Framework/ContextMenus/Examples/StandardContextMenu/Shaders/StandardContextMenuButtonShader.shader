...
Shader "HoloWorld/Standard Context Menu Button Shader"
{
    Properties
    {
		_RimThickness("Thickness of Button Rim", Range(0, 0.3)) = 0.05
		_RimColor("Color of Button Rim", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "StandardContextMenuButtonShader.cginc"
