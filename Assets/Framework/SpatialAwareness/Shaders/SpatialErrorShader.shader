...
Shader "HoloWorld/Spatial Error Vertex Lit Shader"
{
    Properties
    {
		_TotalAlpha("Total Alpha", Range(0, 1)) = 0
		_PerlinsNoiseSpeed("Perlin's Noise Speed", Float) = 0.2
		_PerlinsNoise("Perlin's Noise", 2D) = "white" {}
		_BordersColor("Borders Color", Color) = (1, 0, 0, 1)
		_BordersThickness("Borders Thickness", Float) = 0.05
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SpatialErrorShader.cginc"
