    ...
    public partial class GestureManager : Singleton<GestureManager>
    {
        ...
        public Vector3 ManipulationHandPosition
        {
            get
            {
                ...
                //return Quaternion.Euler(new Vector3(0, Camera.main.transform.rotation.eulerAngles.y / 2, 0)) * Camera.main.transform.forward * 0.8f;
#else
        ...
        Vector3 editorHandPos;
        Vector3 getEditorCumulativeDelta()
        {
            /*Vector3 result = editorHandPos - Camera.main.transform.forward * 0.8f;
            editorHandPos = Camera.main.transform.forward * 0.8f;*/
            //Debug.Log("editorHandPos.x = " + editorHandPos.x);
            //Debug.Log("editorHandPos.y = " + editorHandPos.y);
            return Camera.main.transform.forward * 0.8f - editorHandPos;
        }

        void updateEditorHandPos()
        {
            editorHandPos = Camera.main.transform.forward * 0.8f;
            //Debug.Log("editorHandPos = " + editorHandPos);
        }
