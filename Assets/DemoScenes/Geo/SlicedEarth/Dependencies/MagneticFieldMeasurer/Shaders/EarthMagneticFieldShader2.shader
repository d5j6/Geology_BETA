...
Shader "HoloWorld/Earth Magnetic Field Shader 2"
{
    Properties
    {
		_ColorNoiseTex("Color Noise Texture", 2D) = "white" {}
	_ColorNoiseXMoveSpeed("Color Noise X Move Speed", Range(0, 10)) = 0
		_ColorNoiseYMoveSpeed("Color Noise Y Move Speed", Range(0, 10)) = 0
    ...
    SubShader
    {
        Tags { "RenderType" = "MKGlow" "Queue" = "Transparent" "PerformanceChecks" = "False" }
        ...
        #include "EarthMagneticFieldShader2.cginc"
