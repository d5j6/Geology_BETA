...
Shader "HoloWorld/Curved Space Unlit Shader"
{
    Properties
    {
		_Coeff("Curving Coeff", Range(0, 1)) = 0
		_Thickness("Curve Thickness", Range(0, 1)) = 0.01
		_Centering("Centering of Mass", Range(0, 1)) = 0
		_Spreading("Spreading", Range(0, 6.28)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "CurvedSpaceUnlit.cginc"
