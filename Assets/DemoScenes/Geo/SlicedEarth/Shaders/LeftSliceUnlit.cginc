...
v2f vert(appdata_t v)
{
	if (v.vertex.r < 0)
	{
		v.vertex = float4(cos(_Closed * 1 * 6.28318530718f)*sin((v.vertex.b + 0.5)*3.14159265f)*0.5*_DiameterOuter, cos((v.vertex.b + 0.5)*3.14159265f) *-0.5*_DiameterOuter, sin(_Closed * 1 * 6.28318530718f)*sin((v.vertex.b + 0.5)*3.14159265f)*0.5*_DiameterOuter, 1);
	}
	else
	{
		v.vertex = float4(cos(_Closed * 1 * 6.28318530718f)*sin((v.vertex.b + 0.5)*3.14159265f)*0.5*_DiameterInner, cos((v.vertex.b + 0.5) * 3.14159265f) *-0.5*_DiameterInner, sin(_Closed * 1 * 6.28318530718f)*sin((v.vertex.b + 0.5)*3.14159265f)*0.5*_DiameterInner, 1);
	}
...
float4 frag(v2f i) : SV_Target
{
    ...
    #if _USEMAINTEX_ON
		half2 coods = float2(0.5h - 0.5h* sin(i.texcoord.g*3.14159265359h)*lerp(_DiameterOuter, _DiameterInner, 1.0h - i.texcoord.r), 0.5h - 0.5h* cos(i.texcoord.g*3.14159265359h)*lerp(_DiameterOuter, _DiameterInner, 1.0h - i.texcoord.r));
