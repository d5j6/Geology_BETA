...
Shader "HoloWorld/Configurable Hidable Black Transparent Shader"
{
    Properties
    {
		_VerticalStart("Vertical Start", Range(0, 1)) = 0
		_VerticalEnd("Vertical End", Range(0, 1)) = 1
		_HorizontalStart("Horizontal Start", Range(0, 1)) = 0
		_HorizontalEnd("Horizontal End", Range(0, 1)) = 1
		_BorderColorMultiplier("Border Color Multiplier", Range(1, 10)) = 1
		_BorderThickness("Thickness of Border",  Range(0, 1)) = 0.1
    ...
    SubShader
    {
        ...
        #include "ConfigurableHidableBlackTransparentShader.cginc"
