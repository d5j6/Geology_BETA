...
Shader "HoloWorld/Dots Shader"
{
	Properties
	{
		_DotsSize("Size of Dots", Range(0, 1)) = 0.1
		_DotsFrequency("Frequency of Dots", Range(1, 100)) = 20
		_DotsColor("Color of Dots", Color) = (1,1,1,1)
		_DotsColorFading("Dots Color Fading", Range(0, 1)) = 0
		_DotsFadingOuterRange("Dots Fading Outer Range", Range(0, 1)) = 1
		_DotsFadingInnerRange("Dots Fading Inner Range", Range(0, 1)) = 0.5
